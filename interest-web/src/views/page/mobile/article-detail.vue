              ...
              <div class="ql-container ql-snow">
                  <div class="ql-editor">
                      ...
                      <dl class="list-user-other">
                          <dt>
                              <a :href="$store.state.userMobileUrlPre+article.userid" target="_blank">
                                <el-avatar :src="article.userHeadImg" size="small"></el-avatar>
                              </a>
                          </dt>
                          <dd>
                              <a :href="$store.state.userMobileUrlPre+article.userid" target="_blank">{{article.userName}}</a>
                          </dd>
                          <dd>
          ...
          <div class="comment-section">
              ...
              <ul class="reply-list">
                  <li v-for="(comment, index) in comments" class="reply-item" :key="comment.id">
                          <div class="user">
                              <a :href="$store.state.userMobileUrlPre+comment.userid" target="_blank">
                      ...
                      <ul v-show="comment.showContent" class="reply-child-list">
                          <li v-for="(replyComment,replyIndex) in comment.childComments" class="reply-item" :key="replyComment.id">
                              <div class="reply-info">
                                  <div class="title-info">
                                      <a :href="$store.state.userMobileUrlPre+replyComment.userid" target="_blank">
